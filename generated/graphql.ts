...
export type RequiredPublicationFieldsFragment = {
	__typename: 'Publication'
	id: string
	url: string
	urlPattern: UrlPattern
	...
	imprint?: string | null
	isTeam: boolean
	about?: { __typename?: 'Content'; html: string; text: string } | null
	features: {
		__typename?: 'PublicationFeatures'
		newsletter: { __typename?: 'NewsletterFeature'; isEnabled: boolean }
		viewCount: { __typename?: 'ViewCountFeature'; isEnabled: boolean }
	...
	preferences: {
		...
		layout?: PublicationLayout | null
		disableFooterBranding?: boolean | null
		isSubscriptionModalDisabled?: boolean | null
		darkMode?: {
			__typename: 'DarkModePreferences'
			logo?: string | null
	...
	domainInfo: {
		...
		wwwPrefixedDomain?: { __typename: 'DomainStatus'; host: string; ready: boolean } | null
	}
...
export type HomePageInitialQuery = {
	...
	publication?: {
		...
		imprint?: string | null
		isTeam: boolean
		about?: { __typename?: 'Content'; markdown: string; html: string; text: string } | null
		...
		seriesList: {
			...
			edges: Array<{
				__typename?: 'SeriesEdge'
				node: { __typename?: 'Series'; slug: string; id: string; name: string }
			}>
		}
		features: {
			__typename?: 'PublicationFeatures'
					...
					},
					{
						...
						selectionSet: {
							...
							selections: [
								...
								{
									kind: 'Field',
									name: { kind: 'Name', value: 'disableFooterBranding' }
								},
								{
									kind: 'Field',
...
export const RequiredPublicationFieldsFragmentDoc = {
	kind: 'Document',
	definitions: [
		{
			kind: 'FragmentDefinition',
			name: { kind: 'Name', value: 'RequiredPublicationFields' },
			typeCondition: { kind: 'NamedType', name: { kind: 'Name', value: 'Publication' } },
			selectionSet: {
				kind: 'SelectionSet',
				selections: [
					...
					{ kind: 'Field', name: { kind: 'Name', value: 'title' } },
					{ kind: 'Field', name: { kind: 'Name', value: 'displayTitle' } },
					{ kind: 'Field', name: { kind: 'Name', value: 'hasBadges' } },
					{ kind: 'Field', name: { kind: 'Name', value: 'descriptionSEO' } },
					{
						kind: 'Field',
						name: { kind: 'Name', value: 'about' },
					...
					},
					{
						...
						selectionSet: {
							...
							selections: [
								...
								{
									kind: 'Field',
									name: { kind: 'Name', value: 'isSubscriptionModalDisabled' }
								}
							]
						}
					},
					...
					{ kind: 'Field', name: { kind: 'Name', value: 'headerColor' } },
					{
						...
						selectionSet: {
							...
							selections: [
								...
								{
									kind: 'Field',
									name: { kind: 'Name', value: 'wmPaymentPointer' }
								},
					...
					},
					{
						...
						selectionSet: {
							...
							selections: [
								...
								{
									kind: 'Field',
									name: { kind: 'Name', value: 'hashnodeSubdomain' }
								},
								{
									kind: 'Field',
								...
								{
									kind: 'Field',
									name: { kind: 'Name', value: 'wwwPrefixedDomain' },
									selectionSet: {
										kind: 'SelectionSet',
										selections: [
											{
					...
					{
						kind: 'Field',
						name: { kind: 'Name', value: 'redirectionRules' },
						selectionSet: {
							kind: 'SelectionSet',
							selections: [
...
} as unknown as DocumentNode<RequiredPublicationFieldsFragment, unknown>
					...
					},
					{
						...
						selectionSet: {
							...
							selections: [
								...
								{
									kind: 'Field',
									name: { kind: 'Name', value: 'stickCoverToBottom' }
								}
							]
						}
					},
										...
										selections: [
											{
												...
												name: {
													kind: 'Name',
													value: 'RequiredStaticPageFields'
												}
											}
										]
									}
				...
				selections: [
					{
						...
						selectionSet: {
							kind: 'SelectionSet',
							selections: [
								{ kind: 'FragmentSpread', name: { kind: 'Name', value: 'Draft' } }
							]
						}
					}
				]
